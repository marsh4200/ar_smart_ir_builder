...
def _build_ha_scripts_export(device_key: str, device: dict[str, Any]) -> str:
    ...
    lines.append(f"# Generated by AR Smart IR Builder v2.0.0")
        ...
        async_register_built_in_panel(
            ...
            config={
                "_panel_custom": {
                    ...
                    "js_url": f"/api/{DOMAIN}/static/panel.js?v=23",
                }
            },
            require_admin=True,
        )
...
def _async_register_services(hass: HomeAssistant) -> None:
    ...
    async def export_ha_scripts(call: ServiceCall) -> None:
        ...
        yaml_content = _build_ha_scripts_export(device_key, device)
