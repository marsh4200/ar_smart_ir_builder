...
def _build_smartir_export(device_key: str, device: dict[str, Any], controller: str) -> dict[str, Any]:
    ...
    controller_label = "MQTT (Tasmota)" if controller == CONTROLLER_TASMOTA_MQTT else "Broadlink"
    ...
    return {
        ...
        "commandsEncoding": profile.get("commands_encoding")
        or ("TasmotaIR" if controller == CONTROLLER_TASMOTA_MQTT else "Base64"),
...
def _build_ha_scripts_export(
    ...
    lines.append(f"# Generated by AR Smart IR Builder v2.1.0")
        ...
        async_register_built_in_panel(
            ...
            config={
                "_panel_custom": {
                    ...
                    "js_url": f"/api/{DOMAIN}/static/panel.js?v=26",
                }
            },
            require_admin=True,
        )
...
def _async_register_services(hass: HomeAssistant) -> None:
    ...
    async def export(call: ServiceCall) -> None:
        ...
        export_payload = _build_smartir_export(call.data["device_key"], device, controller)
